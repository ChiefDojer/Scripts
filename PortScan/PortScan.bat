...
:: ----------------------------------------------------------------
:: PortScan.bat — Windows launcher (cmd / PowerShell)
:: Finds Git Bash via registry and runs PortScan.sh with it.
:: Pass any arguments through to the script, e.g.:
::   PortScan.bat --ports all --no-subnet
:: ----------------------------------------------------------------
